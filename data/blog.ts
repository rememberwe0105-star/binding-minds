...
Thanks to 482 generous donors on Dear Giver, the campaign has raised $36,400 of its $50,000 goal. But beyond the financials, the real story is in the impact:
...
*Ready to contribute? [Find the campaign on Dear Giver](/campaigns/restore-native-forest) and make your donation today.*`,
  },
  {
    id: 'blog-002',
    ...
    featured: true,
    content: `If you're donating to charity in New Zealand, you could be leaving money on the table. The IRD offers a generous 33.33% tax credit on donations to approved organisations — and with Dear Giver, claiming it has never been easier.
...
With Dear Giver, this step is automated. Your Receipt Vault consolidates all your donations into a single, IRD-ready tax summary. No more hunting through emails.
...
Upload your Dear Giver tax summary or manually enter:
- Organisation name
- Donation amount
- Date of donation
...
The "Supporting Local Art" campaign, funded through Dear Giver, has commissioned 12 large-scale murals across four Wellington suburbs:
